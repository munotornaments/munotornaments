...
<!-- Mirrored from webdesign-finder.com/html/qtyler/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Jul 2018 01:34:17 GMT -->
<head>
...
<body>
		...
		<div id="box_wrapper">
			...
			<section class="page_topline ds background_cover">
				<div class="container-fluid">
					<div class="row flex-wrap v-center">
						...
						<a href="tel:9820364873">+91 9820364873</a>
					</span> <span>
						<i class="qtyler-envelope rightpadding_5"></i>
						<a href="mailto:munotornaments@yahoo.co.in">munotornaments@yahoo.co.in</a>
					</span> </div>
						</div>
			...
			<header class="page_header header_white header_v1 toggler_xxs_right">
				<div class="container-fluid">
					<div class="row">
                        ...
                        <img src="images/logo.png" height="80" width="110" alt="">
                    </a> </div>
			...
			<section class="ls section_padding_top_150 section_padding_bottom_150 columns_padding_30 columns_margin_bottom_40">
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
							<section id="map" class="ls ms" data-address="Shop no A12/13/14, Ground Floor, Glitz Mall, 99-Vithalwadi, Kalbadevi, Mumbai-400002">
								<!-- marker description and marker icon goes here -->
								<div class="map_marker_description">
									<h3>Munot Ornaments Annex</h3>
									<p> Glitz Mall</p> <img class="map_marker_icon" src="images/map_marker_icon.png" alt=""> </div>
							</section>
						</div>
							...
							<ul class="list1 no-bullets">
								...
								<li>
									<div class="media teaser media-icon-teaser">
										...
										<div class="media-body media-middle">
											<h4>Email:</h4>
											<p><a href="mailto:munotornaments@yahoo.co.in">munotornaments@yahoo.co.in</a></p>
										</div>
									</div>
								</li>
								<li>
 ...
 -->
								...
								<ul class="list-unstyled greylinks">
									<li>
										<div class="media small-media">
											...
											<div class="media-body"><a href="tel:02222404776">+(022) 2240 4776</a><br><a href="tel:9820364873">+91 9820364873</a></div>
										</div>
									</li>
									<li>
										<div class="media small-media">
											<div class="media-left"> <i class="qtyler-envelope"></i> </div>
											<div class="media-body"> <a href="mailto:munotornaments@yahoo.co.in">munotornaments@yahoo.co.in</a> </div>
										</div>
									</li>
								...
								<ul class="list-unstyled greylinks">
									<li>
										<div class="media small-media">
											...
											<div class="media-body"> Shop no A12/13/14, Ground Floor, Glitz Mall, 99-Vithalwadi, Kalbadevi, Mumbai-400002</div>
										</div>
									</li>
								</ul>
							</div>
			...
			<section class="page_copyright ds background_cover section_padding_top_10 section_padding_bottom_10">
				<div class="container">
					<div class="row">
						<div class="col-xs-12 text-center"> &copy; Copyright 2018-2023 All Rights Reserved. Designed by <a href="http://www.web21cen.in">Web21Cen </a></div>
					</div>
				</div>
			</section>
		</div>
